...
# List of 71 features expected by the model
EXPECTED_FEATURES = [
...
def load_saved_artifacts():
    ...
    __data_columns = [col for col in __data_columns if col in EXPECTED_FEATURES]
